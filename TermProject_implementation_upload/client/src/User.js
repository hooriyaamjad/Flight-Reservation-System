...
function User(props) {
    ...
    const handleLogout = () => {
      ...
      const deleteUserFlight = (email, flight_id, seat_num) => {
                ...
                {userFlightList.map((flight, index) => {
                    return (
                        <div class = "user-flight">
                            ...
                            <button class = "delete-user-flight" onClick={() => {deleteUserFlight(email, flight.Flight_IDNum, flight.Seat_number)}}>Cancel Flight</button>
                        </div>
                    )
                })}
            </div>
