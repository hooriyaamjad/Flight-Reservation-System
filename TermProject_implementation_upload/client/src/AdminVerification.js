...
function AdminVerification(props) {
    ...
    const handleLogout = () => {
      ...
      const fillAdminPassword = () => {
        axios.get(`http://localhost:3002/admin-password`).then((response) => {
        ...
        <>
            ...
            <div class = "header-cont">
                ...
                <div class = "header-title-1">
                    ...
                    <div id = "title-desc"><b>Please verify your status as an admin by entering the database password below!</b></div>
                </div>
            ...
            <div class = "admin-login-cont">
                <h3 id = "login-password-header">Enter the login password here:</h3>
                <input
                    type="text"
