...
public class LoginConnection {
    ...
    public String[] getAdminPassword() {
         try {
            ...
            String nodeServerUrl = "http://localhost:3002/admin-password";
    ...
    public String[] getEmployeePassword() {
         try {
            ...
            String nodeServerUrl = "http://localhost:3002/employee-password";
    ...
    public void createNewAccount(String email, String password) {
        try {
            ...
            String nodeServerUrl = "http://localhost:3002/new-account";
    ...
    public String[] getAllAccounts() {
         try {
            ...
            String nodeServerUrl = "http://localhost:3002/get-accounts";
